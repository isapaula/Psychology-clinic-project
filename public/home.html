...
<head>
    ...
    <!-- esse icone fica ao lado do titulo na aba da pagina --><link rel="icon" href="assets/img/icons8.png">
    <!-- google icons-->
        ...
        <div class="navbar-fixed">   
            <nav class="navbar z-depth-0">
                <div class="nav-wrapper container">
                    ...
                    <a href=""><img class="logo_img" src="assets/img/icons864.png" alt="Clinica psicologia"></a>
        ...
        <div class="row container banner">
            <div class="col s12 center">       
                ...
                <p class="black-text light">
                    Esse sistema tem o objetivo de oferecer consultas de psicologia gratuitas para a comunidade. Nossos alunos do 8° semestre em diante estão prontos para atender à comunidade e contam com a ajuda dos professores para esse processo.
                </p>
                <div class="row">
    ...
    <section class="sobre bloco scrollspy" id="sobre">
        <div class="row container">
            ...
            <div class="col s12 l6">
                <p class="light paragrafo">Esse sistema tem o objetivo de oferecer consultas de psicologia gratuitas para a comunidade. Nossos alunos do curso de psicologia do 8° semestre em diante estão prontos para atender à comunidade e contam com a ajuda dos professores para esse processo. A comunidade faz o cadastro no sistema, informa a queixa (ansiedade, depressão, TDAH, psicanálise, etc.) e solicita atendimento.
Então as pessoas da comunidade entram em uma fila de triagem para análise e, caso o cadastro seja aprovado, a pessoa da comunidade poderá realizar a consulta com um dos nossos alunos presencialmente em uma sala na universidade ou remotamente pelo Teams. Após a primeira consulta, a pessoa da comunidade tem as opções de continuar o tratamento, periodicamente, desistir ou solicitar para trocar de aluno conforme disponibilidade.</p>
            </div>
            <div class="col s12 l6">
                <br>
                <div class="carousel carousel-slider">
                    <a href="#" class="carousel-item"><img src="assets/img/clinica1.jpg" alt="cerebro"></a>
                    <a href="#" class="carousel-item"><img src="assets/img/clinica2.jpg" alt=""></a>
                    <a href="#" class="carousel-item"><img src="assets/img/clinica3.jpg" alt=""></a>
    ...
    <section class="servicos bloco scrollspy" id="servicos">
        ...
        <div class="row container">
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    <div class="card-image">
                        <img src="assets/img/Consultas.jpeg" alt="brain" class="material-boxed">
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    <div class="card-image">
                        <img src="assets/img/imagemProntuario.jpeg" alt="brain" class="material-boxed">
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    <div class="card-image">
                        <img src="assets/img/sessoes.jpeg" alt="brain" class="material-boxed">
            ...
            <article class="col s12 m6 l3">
                <div class="card">
                    <div class="card-image">
                        <img src="assets/img/MaisInfo.jpeg" alt="brain" class="material-boxed">
        ...
        <div class="row container">
            <article class="col s12 l6">
                <div class="card horizontal">
                    <div class="card-image">
                        <img src="assets/img/clinica2.jpg" alt="plano">
                    </div>
            ...
            <article class="col s12 l6">
                <div class="card horizontal">
                    <div class="card-image">
                        <img src="assets/img/clinica1.jpg" alt="plano">
                    </div>
                    <div class="card-stacked">
                        <div class="card-content">
    ...
    <div class="depoimentos blue-logo">
        <div class="row container">
            ...
            <div class="col s12 m4 center">
                <img src="assets/img/person_1.jpg" class="circle responsive-img " alt="person1" >
            ...
            <div class="col s12 m4 center">
                <img src="assets/img/person_4.jpg" class="circle responsive-img " alt="person1" >
                <p class="light white-text">
            ...
            <div class="col s12 m4 center">
                <img src="assets/img/person_2.jpg" class="circle responsive-img " alt="person1" >
                <p class="light white-text">
    ...
    <!--
        ...
        <footer class="rodape">
            <div class="row container center">
                <img src="assets/img/icons864.png" class="logo_img" alt="">
                <p>
